...
$statement = $conn->prepare("SELECT * FROM `posts` WHERE imageuserid in ($array) order by TIMESTAMP DESC LIMIT :getal OFFSET :offset");
...
$nolimit = $conn->prepare("SELECT * FROM `posts` WHERE imageuserid in ($array) order by TIMESTAMP DESC");
